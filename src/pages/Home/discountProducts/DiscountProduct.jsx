        ...
        >
          {discount.map((dis) => (
            <SwiperSlide dis={dis} key={dis._id} className="relative ">
              ...
              />
              <p className="absolute font-open-sans top-2 left-2  bg-orange-300 text-white rounded-full p-2 sm:p-  ">
                {dis.discount}%
              </p>
              <p className="absolute font-open-sans  top-2 right-2 bg-gray-50  text-gray-700 rounded-full p-1 sm:p-  ">
                {dis.itemName}
              </p>
            </SwiperSlide>
          ))}
