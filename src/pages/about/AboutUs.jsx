...
const AboutUs = () => {
  return (
    <div className="container text-black mx-auto font-open-sans">
      <Helmet>
        <meta charSet="utf-8" />
      ...
      <div className="pt-5 m-5 ">
        <section className="rounded-xl font-montserrat shadow-md transform transition duration-300 hover:scale-105 bg-gray-100 text-gray-700 py-20 text-center  px-4">
      ...
      <div className="pt-5 m-5">
        ...
        <section className="py-16 rounded-xl shadow-md  px-4 md:px-20 text-center bg-orange-50 transform transition duration-300 hover:scale-105 ">
          <h2 className="text-3xl font-montserrat font-semibold mb-6 text-sky-500">
            Our Vision
          </h2>
